  ...
  return (
    <>
      ...
      <div className={Info ? "container-info container-info-visible" : "container-info"}>
        ...
        <p className="exampleinformation">
          {` [
            {"pregunta" : "Aqui la pregunta" , "respuesta": "Aqui la respuesta"}, <- la coma si le sigue otra pregunta, si es la ultima no.
  ] <-todo encerrado entre corchetes`}
        </p>
        <p>
          <span style={{ fontWeight: 1000 }}>Ejemplo:</span>
          {"  "}
          <span className="exampleinformation">{` [  {"pregunta": "¿Quién escribió la novela 'Cien años de soledad'?", "respuesta": "Gabriel García Márquez"}
  ] `}</span>
        </p>
      </div>
    </>
